window.addEventListener('DOMContentLoaded',()=>{
    setupEventListeners();
}) /* Quando o conteúdo do DOM estiver completamente carregado, execute a função setupEventListeners(). */
...
function tocarSom(som){
    som.currentTime = 0; //Reinicia o som para o inicio
    som.play();
}
...
function iniciarJogo(){
    ...
    btnPausar.disabled = false; //Habilita o botão pausar
...
//Remove o listner antigo para evitar multiplos inicios
